        ...
        <main>
            ...
            <section class="job_pos" aria-labelledby="job_1">   
                <!-- heading links to apply page with a blank title so it opens in the same page-->                
                        <h4 class="job_title" id="job_1">Entry Level Web Developer</h4> 
                        <h5 class="jobno">Job No <br></h5> 
                        <p class="job_num">#B28L0</p>
                        ...
                        <dl class="job_list">
                            ...
                            <dt><strong>Salary:</strong></dt>
                                <dd>$0</dd>
                            <dt><strong>Reporting Line:</strong></dt>
                                <dd>Head of Web Development<dd>
                            <dt><strong>Key Responsibilities:</strong></dt>
                                <dd>
                                    <ul class = "job_ul">
            ...
            <section class="job_pos" aria-labelledby="job_2">
                        <h4 class="job_title" id="job_2">Entry Level Software Developer</h4>
                        <h5 class="jobno">Job No <br> </h5> <p class="job_num">#A74K9</p>
                        <ul class="job_list">
                            <dl class="job_list">
                            <dt><strong>Description:</strong></dt>
